...
public class ModItems {
    ...
    public static final BlockItem SCOOBA_DIVING_LOOM = new BlockItem(ModBlocks.SCOOBA_DIVING_LOOM, new Item.Settings().group(AquaticsPlus.AQUA_MATERIALS));
    ...
    public static void registerItems() {
        ...
        Registry.register(Registry.ITEM, new Identifier(AquaticsPlus.MOD_ID, "scooba_diving_loom"), SCOOBA_DIVING_LOOM);
